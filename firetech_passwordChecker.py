...
#Checks if password matches the criteria. Returns 1 if it does, 0 if not
...
#TO-DO change so that you can insert the options as arguments and the check is done here
def get_option():
